...
import com.edu.spring.ai.service.ChatService;
import com.edu.spring.ai.service.WeatherAIService;
...
@Tag(name = "Lab4: Data Augmentation techniques", description = """
        This Lab demonstrates the usage of a Data Augmentation techniques such as Stuffing, Tool Calling/Function calling when retrieving data from LLM.
        """)
@RestController
public class DataAugmentationController {
    ...
    @Operation(summary = "Tool Calling/Function Calling (Used in lower versions of Spring AI - 1.0.6", description = """
            ...
            It calls the weather API to get the information related to weather of the city.
    ...
    @Operation(summary = "Tool Calling/Function Calling (Used in lower versions of Spring AI - 1.0.6", description = """
            ...
            Tools are configured to get current date/time, to set the alarm and to get the exchange rate. These tools are called whenever query demands these information.
